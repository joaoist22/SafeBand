  ...
  <div className="timeline-container">
    ...
    <div className="timeline-item past">
      ...
      <div className="timeline-content">
        <h4>Abril 2026</h4>
        <p>Inicio de desenvolvimento da pulseira e software.</p>
      </div>
    </div>
    ...
    <div className="timeline-item current">
      <div className="timeline-dot"></div>
      <div className="timeline-content">
        <h4>Maio e Junho 2026</h4>
        <p>Desenvolvimento da software e integração com a pulseira.</p>
      </div>
    </div>
    ...
    <div className="timeline-item future">
      <div className="timeline-dot"></div>
      <div className="timeline-content">
        <h4>5 de Julho 2026</h4>
        <p>Inicio do <strong>ElectroDay</strong>.</p>
      </div>
    </div>
